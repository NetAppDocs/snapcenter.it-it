...
+
Fare clic su image:../media/filter_icon.png["Icona del filtro"] E selezionare il nome host e il server Exchange per filtrare le risorse. Quindi fare clic su image:../media/filter_icon.png["Icona del filtro"] per chiudere il riquadro del filtro.
