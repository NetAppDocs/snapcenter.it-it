...
Per impostazione predefinita, dalla versione SnapCenter 6,0, il plug-in SnapCenter per Windows utilizza la porta 909 per la comunicazione TCP di rete. Se la porta 909 è in uso, è possibile configurare un'altra porta per la comunicazione TCP NET.
