...
+
È possibile cercare il gruppo di risorse inserendo il nome del gruppo di risorse nella casella di ricerca o facendo clic su *image:../media/filter_icon.png[""]*, quindi selezionare il tag. Quindi fare clic su *image:../media/filter_icon.png[""]* per chiudere il riquadro del filtro.
