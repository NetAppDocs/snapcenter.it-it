...
+
Nella pagina Resources, l' image:../media/not_supported_icon.png["archiviazione non supportata"] icona indica che il database si trova su sistemi di storage non NetApp.
