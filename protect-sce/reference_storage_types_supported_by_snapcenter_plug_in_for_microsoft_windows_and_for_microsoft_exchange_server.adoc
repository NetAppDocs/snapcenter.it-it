...
Il provisioning SnapCenter e il supporto per la protezione dei dati sono disponibili su Windows Server. Per informazioni aggiornate sulle versioni supportate, consultare  https://imt.netapp.com/matrix/imt.jsp?components=117014;&solution=1259&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"^].
