...
* Devi aver installato Java 17 (per SnapCenter 6.2.1 e versioni successive) o Java 11 (per SnapCenter 6.2 e versioni precedenti) sul tuo host.
+
...
* Devi aver installato Java 17 (per SnapCenter 6.2.1 e versioni successive) o Java 11 (per SnapCenter 6.2 e versioni precedenti) sul tuo host Windows.
+
...
* È necessario aver attivato la connessione SSH basata su password per l'utente root o non root.
* Devi aver installato Java 17 (per SnapCenter 6.2.1 e versioni successive) o Java 11 (per SnapCenter 6.2 e versioni precedenti) sul tuo host Linux.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Scarica Java per tutti i sistemi operativi"]
