...
summary: 'SnapCenter utilizza le credenziali per autenticare gli utenti per le operazioni SnapCenter. Devi creare credenziali per l"installazione di plug-in SnapCenter e credenziali aggiuntive per eseguire operazioni di protezione dei dati su cluster o file system Windows.' 
---
