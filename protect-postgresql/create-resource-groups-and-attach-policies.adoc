...
estensione_file
 a| 
Specifica l'estensione del file di registro dell'archivio.

Ad esempio, se il registro di archivio è log_backup_0_1.log, specificare .log come estensione del file.
