...
+
IL https://imt.netapp.com/imt/imt.jsp?components=180320;180336;&solution=1257&isHWU&src=IMT["Strumento di matrice di interoperabilità (IMT)"] contiene le informazioni più recenti sulle configurazioni supportate.
