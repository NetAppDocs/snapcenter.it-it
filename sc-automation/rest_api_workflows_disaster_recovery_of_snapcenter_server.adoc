...
NOTE: Per un'installazione F5, l'operazione di ripristino viene eseguita come standalone; è necessario eseguire una serie di comandi per creare di nuovo F5. Vedere, collegamento: https://["Come migrare SnapCenter su un altro server"^]
...
|===
Per ulteriori informazioni, consultare https://["API di disaster recovery"^] video.
