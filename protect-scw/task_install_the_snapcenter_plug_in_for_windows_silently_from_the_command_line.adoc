...
.Prima di iniziare
* È necessario aver installato ASP.NET Core Runtime 8.0.24 (e tutte le successive patch 8.0.x) Hosting Bundle.
* È necessario aver installato PowerShell 7.4.13 o versioni successive.
