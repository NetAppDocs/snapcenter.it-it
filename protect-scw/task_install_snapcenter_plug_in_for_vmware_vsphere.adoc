...
Per configurare il certificato CA con SnapCenter Plug-in per VMware vSphere, vedere  https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["Creare o importare un certificato SSL"^].
