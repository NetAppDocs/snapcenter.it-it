...
|===
+
image:../media/application_settings.gif["impostazione dell'applicazione"]
...
NOTE: Le coppie chiave-valore personalizzate sono supportate per i sistemi plug-in MySQL Linux e non sono supportate per il database MySQL registrato come plug-in centralizzato di Windows.
