...
* Devi aver installato Java 17 (Oracle Java, OpenJDK o SAP JDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti sul tuo host.
+
...
* Se si utilizza una versione di MySQL precedente alla 8.0, è necessario installare e abilitare manualmente il plug-in MySQLX. Il plug-in MySQLX è installato e abilitato di default per MySQL 8.0 o versioni successive.
...
* Devi aver installato Java 17 (Oracle Java, OpenJDK o SAP JDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti sul tuo host Windows.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Scarica Java per tutti i sistemi operativi"]
