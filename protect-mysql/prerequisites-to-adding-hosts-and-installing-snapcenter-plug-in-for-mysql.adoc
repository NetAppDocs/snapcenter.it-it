...
* È necessario aver installato Java 17, Java 11 (per SnapCenter 6.2 solo) sul proprio host.
+
...
* È necessario aver installato Java 17, Java 11 (per SnapCenter 6.2 solo) sul proprio host Windows.
+
