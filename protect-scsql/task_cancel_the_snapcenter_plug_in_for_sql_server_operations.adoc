...
Riquadro delle attività
 a| 
. Dopo aver avviato il processo di backup, selezionare image:../media/activity_pane_icon.gif["icona del riquadro attività"] Nel riquadro Activity (attività) per visualizzare le cinque operazioni più recenti.
