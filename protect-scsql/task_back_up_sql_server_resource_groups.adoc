...
+
È possibile cercare il gruppo di risorse inserendo il nome del gruppo di risorse nella casella di ricerca oppure selezionando *image:../media/filter_icon.gif["Icona del filtro"]*, quindi selezionare il tag. Quindi selezionare *image:../media/filter_icon.gif["Icona del filtro"]* per chiudere il riquadro del filtro.
