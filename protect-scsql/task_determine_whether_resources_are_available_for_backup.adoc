...
+
Fare clic su image:../media/filter_icon.png[""] E selezionare il nome host e l'istanza di SQL Server per filtrare le risorse. Quindi fare clic su image:../media/filter_icon.png[""] per chiudere il riquadro del filtro.
