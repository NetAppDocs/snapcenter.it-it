...
Riquadro delle attività
 a| 
. Dopo aver avviato l'operazione di clonazione, fare clic image:../media/activity_pane_icon.gif["icona del riquadro attività"] sul riquadro attività per visualizzare le cinque operazioni più recenti.
