...
* Assicurarsi che ASP.NET Core Runtime 8.0.24 (e tutte le patch successive per la versione 8.0.x) Hosting Bundle e PowerShell 7.4.13 o successiva siano installati sull'host del plug-in Windows.
* Assicurarsi che Java 17 (Oracle Java o OpenJDK) per SnapCenter 6.2.1 e successive, oppure Java 11 per SnapCenter 6.2 e precedenti, sia installato sugli host plug-in Windows e Linux.
