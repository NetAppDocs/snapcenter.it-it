...
* Assicurarsi che PowerShell 7.4.13 sia installato sull'host del plug-in Windows.
* Assicurarsi che Java 17 (Oracle Java o OpenJDK) sia installato sugli host plug-in Windows e Linux (oppure Java 11 per SnapCenter 6.2 solo).
