...
IMPORTANT: Ad esempio, se si utilizza SnapCenter versione 4,8 e si desidera eseguire l'aggiornamento alla versione 6,0, è necessario prima eseguire l'aggiornamento alla versione 4,9 e poi eseguire un aggiornamento alla versione 6,0.
