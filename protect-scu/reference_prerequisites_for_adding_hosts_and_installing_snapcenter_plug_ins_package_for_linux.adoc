...
* È necessario aver installato Java 17, Java 11 (per SnapCenter 6.2 solamente) sul proprio host Linux.
+
...
Pacchetti software richiesti
 a| 
Java 17 (Oracle Java o OpenJDK), Java 11 (per SnapCenter 6.2 solo)
