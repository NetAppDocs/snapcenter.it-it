...
|===
Per informazioni aggiornate sulle versioni supportate, consulta https://imt.netapp.com/matrix/imt.jsp?components=121073;&solution=1257&isHWU&src=IMT[] [Tool della matrice di interoperabilità NetApp^].
