...
parole chiave: clone split, SnapCenter
riepilogo: "È possibile utilizzare SnapCenter per suddividere una risorsa clonata dalla risorsa principale. Il clone suddiviso diventa indipendente dalla risorsa padre".
---
= Dividi un clone
:icone: carattere
:imagesdir: ../media/
...
. Nella vista *Gestisci copie*, selezionare la risorsa clonata (ad esempio, il database o il LUN), quindi fare clic su *image:../media/split_cone.gif["Icona del clone split"]*.
