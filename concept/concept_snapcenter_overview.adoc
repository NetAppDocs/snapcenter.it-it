...
+
https://["Storage Automation Store di NetApp"^]
...
+
Per ulteriori informazioni sulle API REST, vedere https://["Panoramica delle API REST"].

+
Per ulteriori informazioni sui cmdlet di Windows, vedere https://["Guida di riferimento al cmdlet del software SnapCenter"^].

+
Per ulteriori informazioni sui comandi UNIX, vedere https://["Guida di riferimento al comando software SnapCenter"^].
...
+
I plug-in personalizzati sono supportati dalla community e possono essere scaricati da https://["Storage Automation Store di NetApp"^].
...
Gli esempi di plug-in personalizzati MySQL, DB2 e MongoDB per il software SnapCenter possono essere scaricati da https://["Storage Automation Store di NetApp"^].
