...
[role="lead"]
Il software SnapCenter è una piattaforma semplice, centralizzata e scalabile che offre data Protection coerente con l'applicazione per applicazioni, database, file system host e VM su sistemi ONTAP ovunque nel cloud ibrido.
