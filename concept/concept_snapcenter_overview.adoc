...
** Dati su sistemi primari e secondari ONTAP FAS, AFF o ASA e protetti sullo storage a oggetti StorageGRID locale (utilizzando l'integrazione del backup cloud NetApp BlueXP)
...
** Dati su sistemi primari e secondari ONTAP FAS, AFF o ASA e protetti per lo storage di oggetti e archivi nel cloud (utilizzando l'integrazione di NetApp BlueXP Cloud Backup)
...
+
Per ulteriori informazioni sui cmdlet di Windows, vedere https://library.netapp.com/ecm/ecm_download_file/ECMLP2886205["Guida di riferimento al cmdlet del software SnapCenter"^].
