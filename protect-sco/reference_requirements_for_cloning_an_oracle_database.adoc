...
+
Per informazioni su come modificare il parametro asm_diskstring, vedere https://["Come aggiungere i percorsi dei dischi ad asm_diskstring"^].
...
+
**** https://["Guida all'installazione e all'installazione delle utility host Linux"^]
**** https://["Guida all'installazione e all'installazione delle utility host DI AIX"^]
