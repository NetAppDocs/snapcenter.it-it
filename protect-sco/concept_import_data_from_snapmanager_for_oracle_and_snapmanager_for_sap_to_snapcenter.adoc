...
Le configurazioni supportate con il plug-in SnapCenter per database Oracle sono elencate nella https://imt.netapp.com/matrix/imt.jsp?components=117016;&solution=1259&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"^].
