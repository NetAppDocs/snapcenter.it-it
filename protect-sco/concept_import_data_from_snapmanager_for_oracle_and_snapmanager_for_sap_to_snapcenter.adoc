...
Le configurazioni supportate con il plug-in SnapCenter per Oracle Database sono elencate in https://imt.netapp.com/imt/imt.jsp?components=180320;180338;180332;&solution=1257&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"^].
