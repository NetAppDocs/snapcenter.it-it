...
Altri hypervisor
 a| 
Linux in esecuzione su KVM, Xen, Hyper-V e hypervisor hyperscaler è supportato quando il sistema operativo guest ha accesso TCP/IP diretto alle risorse di storage ONTAP utilizzando i seguenti metodi:
...
NOTE: I datastore e le presentazioni raw dei dispositivi non sono supportati al di fuori di VMware.
