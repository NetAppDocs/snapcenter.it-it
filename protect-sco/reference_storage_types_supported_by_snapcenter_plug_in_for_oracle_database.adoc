...
|===
Il https://imt.netapp.com/matrix/imt.jsp?components=112391;&solution=1259&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"] contiene le informazioni più recenti sulle versioni supportate.
