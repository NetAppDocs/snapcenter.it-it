...
Le informazioni sui parametri che possono essere utilizzati con il comando e le relative descrizioni possono essere ottenute eseguendo Get-Help nome_comando.  In alternativa, è possibile fare riferimento a https://library.netapp.com/ecm/ecm_download_file/ECMLP3359469["Guida di riferimento al comando software SnapCenter"^] .
