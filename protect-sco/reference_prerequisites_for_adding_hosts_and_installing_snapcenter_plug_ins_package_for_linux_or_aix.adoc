...
* È necessario aver installato Java 17 sul proprio host Linux o AIX.
+
...
NOTE: Assicurati di aver installato solo la versione certificata di Java 17 sull'host Linux.
