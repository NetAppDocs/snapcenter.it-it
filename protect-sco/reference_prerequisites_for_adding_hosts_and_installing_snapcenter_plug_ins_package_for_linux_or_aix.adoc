...
* È necessario aver installato Java 17 (per SnapCenter 6.2.1 e versioni successive) oppure
* Java 11 (per SnapCenter 6.2 e versioni precedenti) sul tuo host Linux o AIX.
+
** Java di Oracle e OpenJDK sono supportati per Linux.
...
Pacchetti software richiesti
 a| 
* Java 17 (Oracle o OpenJDK) per SnapCenter 6.2.1 e versioni successive o
* Java 11 per SnapCenter 6.2 e versioni precedenti
...
Pacchetti software richiesti
 a| 
* IBM Java 17 per SnapCenter 6.2.1 e versioni successive o
* IBM Java 11 per SnapCenter 6.2 e versioni precedenti
