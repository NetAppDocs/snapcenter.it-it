...
* È necessario aver installato Java 17, Java 11 (per SnapCenter 6.2 solo) sul proprio host Linux o AIX.
+
...
NOTE: Assicurati di aver installato solo la versione certificata di Java 17 o Java 11 (solo per SnapCenter 6.2) sul sistema host Linux.
...
Pacchetti software richiesti
 a| 
Java 17 (Oracle o OpenJDK), Java 11 (per SnapCenter 6.2 solo)
...
Pacchetti software richiesti
 a| 
IBM Java 17, IBM Java 11 (per SnapCenter 6.2 solamente)
