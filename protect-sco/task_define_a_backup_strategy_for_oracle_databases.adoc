...
Per informazioni aggiornate sulle versioni di Oracle supportate, consultare https://["Tool di matrice di interoperabilità NetApp"^].
...
Le informazioni relative ai parametri che possono essere utilizzati con il comando e le relative descrizioni possono essere ottenute eseguendo Get-Help command_name. In alternativa, fare riferimento alla https://["Guida di riferimento al comando software SnapCenter"^].
