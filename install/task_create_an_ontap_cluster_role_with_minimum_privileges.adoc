...
NOTE: A partire da SnapCenter 5,0, gli utenti degli amministratori dei cluster sono supportati solo con API REST. Se si desidera creare ruoli utilizzando un amministratore non cluster, è necessario utilizzare ZAPI.
