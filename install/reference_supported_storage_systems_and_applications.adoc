...
+
Per informazioni su Amazon FSX per NetApp ONTAP, vedere https://["Documentazione di Amazon FSX per NetApp ONTAP"^].

* SnapCenter supporta la protezione di diverse applicazioni e database.
+
Per informazioni dettagliate sulle applicazioni e i database supportati, vedere https://["Tool di matrice di interoperabilità NetApp"^].
