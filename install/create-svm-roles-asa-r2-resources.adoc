...
summary: Se si configurano SVM in sistemi ASA R2 da utilizzare con SanpCenter, è necessario creare ruoli SVM senza utilizzare il ruolo di vsadmin, 
---
...
[role="lead"]
Esistono diversi comandi della CLI di ONTAP che devi eseguire per creare un ruolo per un nuovo utente SVM nei sistemi ASA R2. Questo ruolo è necessario se si configurano SVM nei sistemi ASA R2 da utilizzare con SnapCenter e non si desidera utilizzare il ruolo vsadmin.
