...
NOTE: SnapCenter supporta anche il bilanciamento del carico elastico (ELB) di AWS e il bilanciamento del carico di Azure.
...
+
Per ulteriori informazioni, vedere https://docs.netapp.com/us-en/snapcenter-cmdlets/index.html["Guida di riferimento al cmdlet del software SnapCenter"^].
