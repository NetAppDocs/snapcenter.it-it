...
NOTE: Le licenze servizi file NAS SnapCenter e SnapCenter sono obsolete e non sono più disponibili. La licenza basata sulla capacità non è più necessaria per Amazon FSX per NetApp ONTAP e Cloud Volumes ONTAP. Per Azure NetApp Files non sono richieste le licenze standard e la licenza basata sulla capacità.
