...
NOTE: A partire da 5,0, gli utenti amministrativi dei vserver sono supportati solo con API REST. Se si desidera creare ruoli utilizzando un amministratore non vserver, è necessario utilizzare ZAPI.
