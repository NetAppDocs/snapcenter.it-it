...
Consultare link:https://techdocs.broadcom.com["Documentazione Tecnica Broadcom"^] e cercare la documentazione sul clustering di macchine virtuali su host fisici e sulla creazione di LUN FC RDM condivise per cluster Microsoft.
