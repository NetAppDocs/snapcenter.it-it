...
+
Per informazioni sull'attivazione, visitare il sito Web Microsoft https://["Registrazione del programma di installazione di Windows"^].
...
. Scaricare il pacchetto di installazione del server SnapCenter da https://["Sito di supporto NetApp"^].
