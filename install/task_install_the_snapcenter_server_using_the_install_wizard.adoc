...
È possibile eseguire facoltativamente diverse procedure di installazione e configurazione utilizzando i cmdlet di PowerShell. È necessario utilizzare PowerShell 7.4.13 o versioni successive.
...
** Pacchetto di hosting ASP.NET Core 10.0.7 (o versioni successive) Consulta la link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter Software Note di rilascio"^] per le versioni più recenti di ASP.NET Core qualificate per la tua versione specifica di SnapCenter.
** Include lato server
...
+
** Attivazione TCP
** Attivazione HTTP Fai riferimento alla link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter Software Note di rilascio"^] per le versioni più recenti di ASP.NET Core qualificate per la tua specifica versione di SnapCenter.
