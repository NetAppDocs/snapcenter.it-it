...
+
Se si desidera gestire applicazioni MySQL o DB2, è possibile utilizzare i plug-in personalizzati MySQL e DB2 forniti da NetApp. I plug-in personalizzati MySQL e DB2 sono disponibili sul sito https://["NetApp Automation Store"]
