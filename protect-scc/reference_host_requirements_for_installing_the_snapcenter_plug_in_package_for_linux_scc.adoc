...
Pacchetti software richiesti
 a| 
Java 1,8 (64 bit) Oracle Java o OpenJDK
...
|===
Per informazioni aggiornate sulle versioni supportate, consultare https://imt.netapp.com/matrix/imt.jsp?components=112392;&solution=1259&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"]
