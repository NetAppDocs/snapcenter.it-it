...
+
Fare clic su image:../media/filter_icon.png[""], quindi selezionare il nome host e il tipo di risorsa per filtrare le risorse. Quindi fare clic su image:../media/filter_icon.png[""] per chiudere il riquadro del filtro.
