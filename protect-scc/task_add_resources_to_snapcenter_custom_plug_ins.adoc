...
È inoltre possibile aggiungere risorse per applicazioni MySQL e DB2. Questi plug-in possono essere scaricati da https://["Storage Automation Store di NetApp"].
