...
Vedere link:view_netapp_supported_plugins_resource_backups_and_clones_in_the_topology_page.html["Visualizza backup e cloni relativi alle risorse dei plug-in supportati da NetApp nella pagina topologia"].
