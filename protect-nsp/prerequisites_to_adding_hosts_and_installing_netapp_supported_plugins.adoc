...
* È necessario aver installato Java 17 (Oracle Java o OpenJDK) per SnapCenter 6.2.1 e versioni successive oppure
* Java 11 per SnapCenter 6.2 e versioni precedenti sul tuo host Linux, Windows o AIX.
+
...
+
Se si utilizza Windows Server 2019 o Windows Server 2016 per l'host del server SnapCenter, è necessario installare Java 17 (Oracle Java o OpenJDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti.
...
Pacchetti software richiesti
 a| 
* Java 17 per SnapCenter 6.2.1 e versioni successive, IBM Java o
* Java 11 per SnapCenter 6.2 e versioni precedenti, IBM Java
