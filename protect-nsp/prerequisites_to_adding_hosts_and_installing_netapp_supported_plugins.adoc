...
* È necessario aver installato Java 17 sul proprio host Linux, Windows o AIX.
+
...
* È necessario aver installato Java 17 sul proprio host Linux.
+
Se si utilizza Windows Server 2019 o Windows Server 2016 per l'host del server SnapCenter, è necessario installare Java 17.
