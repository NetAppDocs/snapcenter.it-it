...
* Devi aver installato Java 17 (Oracle Java, OpenJDK o SAP JDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti sul tuo host Linux, Windows o AIX.
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Scarica Java per Windows"]
...
* Devi aver installato Java 17 (Oracle Java, OpenJDK o SAP JDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti sul tuo host Linux.
+
Se usi Windows Server 2019 o Windows Server 2016 per l'host del server SnapCenter, devi installare Java 17 (Oracle Java, OpenJDK o SAP JDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti.

+
link:https://www.oracle.com/java/technologies/downloads/#java17["Scarica Java per Linux"]
...
Pacchetti software richiesti
 a| 
* Java 17 per SnapCenter 6.2.1 e versioni successive, IBM Java o Java 11 per SnapCenter 6.2 e versioni precedenti, IBM Java
