...
* È necessario aver installato Java 17, Java 11 (per SnapCenter 6.2 solo) sul proprio host Linux, Windows o AIX.
+
...
+
Se si utilizza Windows Server 2019 o Windows Server 2016 per l'host del server SnapCenter, è necessario installare Java 17, Java 11 (solo per SnapCenter 6.2).
...
Pacchetti software richiesti
 a| 
Java 17, Java 11 (per SnapCenter 6.2 solo), IBM Java
