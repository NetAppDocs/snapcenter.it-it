...
---
= Monitorare le operazioni di cloning delle risorse plug-in supportate da NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Fare clic su image:../media/filter_icon.png["Icona del filtro"] per filtrare l'elenco in modo che vengano elencate solo le operazioni di clonazione.
