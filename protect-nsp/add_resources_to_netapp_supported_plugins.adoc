...
* ORACLE_EXPORT_PARAMETERS specifica se è possibile esportare le variabili d'ambiente durante l'esecuzione di _bin/su_. Il valore di ORACLE_EXPORT_PARAMETERS deve essere impostato su *y*.
