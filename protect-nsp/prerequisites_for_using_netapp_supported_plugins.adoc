...
* Se applicabile, installare Java 17 (Oracle Java o OpenJDK) per SnapCenter 6.2.1 e versioni successive oppure
* Java 11 per SnapCenter 6.2 e versioni precedenti sull'host del plug-in.
