...
. Nella pagina conservazione e backup, specificare le impostazioni di conservazione per il tipo di backup e il tipo di pianificazione selezionato nella pagina tipo di backup:
