...
+ in base all'etichetta Snapshot selezionata, ONTAP applica la policy di conservazione Snapshot secondaria corrispondente all'etichetta.

+ NOTA: Se è stato selezionato *Aggiorna SnapMirror dopo aver creato una copia istantanea locale*, è possibile specificare l'etichetta del criterio secondario. Tuttavia, se è stato selezionato *Aggiorna SnapVault dopo la creazione di una copia Snapshot locale*, è necessario specificare l'etichetta del criterio secondario.
