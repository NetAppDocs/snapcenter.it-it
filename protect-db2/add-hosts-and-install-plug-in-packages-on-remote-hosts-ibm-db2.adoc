...
+
link:../protect-db2/task_configure_gMSA_on_windows_server_2012_or_later.html["Configurare l'account del servizio gestito di gruppo su Windows Server 2016 o versioni successive per IBM DB2"^]
...
.Al termine
Se si desidera eseguire l'aggiornamento alla versione SnapCenter 6,0, il plug-in basato su PERL esistente per DB2 verrà disinstallato dal server plug-in remoto.
