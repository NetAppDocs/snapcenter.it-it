...
* È necessario aver attivato la connessione SSH basata su password per l'utente root o non root.
* Devi aver installato Java 17 (Oracle Java, OpenJDK o SAP JDK) per SnapCenter 6.2.1 e versioni successive oppure Java 11 per SnapCenter 6.2 e versioni precedenti sui tuoi host Linux o AIX.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Scarica Java per Linux"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Scarica Java per AIX"^]
