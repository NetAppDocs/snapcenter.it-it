...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Scarica JAVA per Windows"^]
...
* È necessario aver attivato la connessione SSH basata su password per l'utente root o non root.
* È necessario aver installato Java 11 sui propri host Linux o AIX.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Scarica JAVA per Linux"^]
