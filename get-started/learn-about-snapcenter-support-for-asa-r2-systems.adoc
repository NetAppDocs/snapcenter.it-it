...
NOTE: Dopo l'aggiornamento a SnapCenter 6.2.1 (server e plug-in) e ONTAP 9.17.1, SnapCenter converte i gruppi di coerenza flat in gruppi di coerenza gerarchica durante il primo backup pianificato.
